# explore-pattern-game

## Purpose

Defines deterministic pattern-completion interactions: supported versioned pattern grammars, unique-missing-answer generation and validation, level-bounded token attributes, tap/drag completion, and grammar/materializer/validator conformance.
