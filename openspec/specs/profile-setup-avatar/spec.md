# Spec: Profile Setup — Avatar

## Purpose

Step 3 (final step) of the profile setup flow, where the child picks an avatar. Completing this step finalises onboarding and navigates to Home.
