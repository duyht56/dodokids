# explore-memory-match-game

## Purpose

Defines deterministic offline memory-match boards, approved asset eligibility, responsive interaction state and pressure-free play for Explore.
