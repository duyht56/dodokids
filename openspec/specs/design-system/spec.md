...
Defines requirements for the design system token setup in the Kido app, covering color tokens, typography, spacing, border radius, shadows, and touch target constants — all aligned to the Kido Design Handoff v1.0.
