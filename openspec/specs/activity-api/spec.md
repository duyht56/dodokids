...
Defines the backend API surface for lesson playback: fetching the active lesson, recording completion with XP, streak calculation, and the weekly parent report.
