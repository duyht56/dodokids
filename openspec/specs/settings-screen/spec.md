...
Defines the Settings screen rendered as the Settings tab in the parent bottom navigator. Covers child profile editing, subscription status display, sound controls, notification toggles, and an about section — all using Inter font for the calmer parent-facing tone.
